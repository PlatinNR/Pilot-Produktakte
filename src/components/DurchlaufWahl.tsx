  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-[9px] font-semibold uppercase tracking-wide text-slate-500">Werte</span>
        {runs.length > 1 ? (
          <label className="flex items-center gap-1">
            <select
              ...
              title="Arbeitswiederholung wählen"
            >
              {runs.map((_, i) => (
          ...
          <span className="text-[10px] text-slate-400">1 Durchlauf</span>
        )}
      </div>
